...
from root.shared.schemas.pipeline_messages import EmbeddingTask, HunterResult
from root.worker_normalize.logic.normalize_service import NormalizeService
