...
from root.shared.parsing_failures import ParsingFailure, detect_html_block_reason
...
from root.shared.shared_utils import url_hash
...
class PlaywrightWorkflow:
    ...
    async def _render_and_store(self, url: str, redis_key: str) -> None:
        ...
        if blocked_reason:
            raise ParsingFailure(reason=f"hunter_render_failed:{blocked_reason}")
